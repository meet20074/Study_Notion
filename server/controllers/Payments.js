...
// //         console.log("courses in peeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeayments" , courses);
...
// //             ({
// //                 success : false, 
// //                 message : "No course found to but"
// //             })
// //         }
// //         let TotalAmount =0;
...
// //                   if(!course) {
// //                     return res.status(200).json({success : false , message : "Course  Not found for payment"});
// //                   }
                  
// //                   if(course.studentsEnrolled.includes(uid)){
// //                     return res.status.json(200)({ success : false , message : "Student has already purchased this course"});
// //                   }
...
// //             {
// //                 console.log(err);
// //                 return res.status(200).json({ success : false , message : "Error in Calculating total amount of money for courses selected"})
// //             }
// //         }
...
// //         {
// //             console.log(err);
// //             return res.status(200).json({ success  :false , message : "Could not instantiate payment"});
...
//       success : true , message : "Courses or User ID is not found for enrolling students"
//     });
...
//     if(!enrolledCourse){
//       return res.status(200).json({
//         success : false , message : "Course Not found for update in students enrollment"
//       })
//     }
...
//     if(!enrolledUser){
//       return res.status(200).json({
//         success : false , message : "user Not found for update in courses array"
//       })
//     }
...
//     {
//              console.log(error);
//             return res.status(500).json({success:false, message:"error in enroll of students in course after payment"});
//     }
// }
